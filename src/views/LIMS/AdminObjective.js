...
export default class AdminObjective extends Component {
  ...
  getAllObjectives() {
    axios
      .get(Config.ServerUri + "/get_all_objectives")
      .then((res) => {
        this.setState({
  ...
  deleteObjective() {
    ...
    axios
      .post(Config.ServerUri + "/delete_objective", {
  ...
  createObjective(event) {
    ...
    axios
      .post(Config.ServerUri + "/create_objective", {
  ...
  updateObjective(event) {
    ...
    axios
      .post(Config.ServerUri + "/update_objective", {
        id: this.state.current_id,
        objective: this.state.objective,
        units: this.state.units,
        remark: this.state.remark,
